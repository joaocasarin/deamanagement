...
@Slf4j
public class StudentsGetAllTests {
    ...
    @BeforeEach
    void beforeEach() {
        log.info("Before each test in " + StudentsGetAllTests.class.getSimpleName());
    }

    @BeforeAll
    void beforeSuiteTest() {
        log.info("Before all tests in " + StudentsGetAllTests.class.getSimpleName());
    }
